		...
		{#if code}
			<section id="login" class="prose max-w-[40ch] w-full mx-auto">
				<div class="flex-col gap-0 w-full">
					...
					<p class="mt-1 mb-4 font-normal">Olvidaste tu contraseña?</p>
					...
					<div class="flex flex-col gap-3">
						{#if data.session}
							...
							>
								...
								>
									<iconify-icon icon="raphael:key" class="text-xl" />
									Cambiar contraseña
								</button>
							</form>
						{:else}
						...
						{/if}
						<a href="/" class="link link-hover text-sm text-accent/50 font-normal mx-auto"
							>Volver al inicio</a
						>
					</div>
				</div>
