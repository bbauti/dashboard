...
<div class="flex">
	<div
		class="{localOpen
			? 'lg:pl-56'
			: 'lg:pl-[81px]'} bg-neutral w-full py-5 px-0 lg:py- lg:px-5 flex justify-between items-center transition-all"
	>
	...
	<ul
		class="menu bg-base-100 {localOpen
			? 'w-56 gap-2'
			: 'w-[81px] gap-1'} overflow-hidden h-full box fixed z-10 hidden lg:flex flex-col flex-nowrap overflow-auto transition-all ease-in-out"
	>
